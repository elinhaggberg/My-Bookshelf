...
// uploaded cover photo's actual bytes into this project's private Storage
...
Deno.serve(async (req) => {
  ...
  try {
    switch (action) {
      // Uploads (or replaces) this record's cover. Raw bytes in the request
      ...
      // object isn't an error here -- a record whose cover was never
